...
#
"""
<plugin key="CreasolDomBus" name="Creasol DomBus RS485 modules (inputs, outputs, sensors)" author="Creasol" version="1.1.5" wikilink="http://www.domoticz.com/wiki/Creasol_Dombus" externallink="https://www.creasol.it/domotics">
    <description>
        ...
        <ul style="list-style-type:square">
            ...
            <li>Creasol <b>DomBus32</b> : DIN module with <b>3* SPST 250V 5A relays + 3* AC inputs + 5 I/Os</b>.</li> 
